...
`/` (some project descriptions), `/work` (work.yaml descriptions), `/writing`
(intro and article blurbs), `/audioverse`, `/taskratchet`. Unflagged and
human-written: the newsletter posts, `/uses`, and `/404`.
